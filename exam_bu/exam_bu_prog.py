...
class Exam_bu(QtCore.QState):
    ...
    def __init__(self, parent=None, server=None, form=None):
        ...
        self.btnNo = self.frm_main.btnPanel.btnNo.clicked
        ...
        self.fi_check.addTransition(self.btnNo, self.fi_param_sav)
        ...
        self.fi_measure.addTransition(self.btnNo, self.fi_fail)
        ...
        self.fi_check_r.addTransition(self.btnNo, self.fi_param_sav_r)
        ...
        self.fi_measure_r.addTransition(self.btnNo, self.fi_fail_r)
        ...
        self.shim_graph_finish.addTransition(self.btnNo, self.shim_fail)
        ...
        self.shim_graph_finish_r.addTransition(self.btnNo, self.shim_fail_r)
        ...
        self.ai_measure.addTransition(self.btnNo, self.ai_fail)
        ...
        self.rt_check.addTransition(self.btnNo, self.rt_fail_1)
        ...
        self.rt_100.addTransition(self.btnNo, self.rt_fail_2)
        ...
        self.rt_max.addTransition(self.btnNo, self.rt_fail_3)
...
class Prepare2(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Подключите разъем привода "XS10 ИУ ПЭ" к разъему привода "XP8 НАГРУЗКА", '
                         ...
                         '</p><p>Нажмите "ДА" для продолжения.</p>')
...
class Prepare3(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Подключите при помощи шлейфа разъем пульта "XS12 БП Х2"'
                         ' и разъем "ХР13 24 В"</p><p>Нажмите "ДА" для продолжения.</p>')
...
class Prepare4(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Снимите защитную крышку с разъема БУ "ОСНОВНАЯ РАБОТА" и подключите'
                         ' программатор</p><p>Нажмите "ДА" для продолжения.</p>')
    ...
    def onEntry(self, QEvent):
        if bu.dev_type == 'ЭРЧМ30Т3-06':
            com.text.setText('<p>Переведите переключатель "РЕЗЕРВНАЯ РАБОТА" на БУ в положение '
                             '"ОТКЛ."</p><p>Для продолжения нажмите "ДА"</p>')
        else:
            self.success.emit()
...
class ConnectBUDI(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        elif bu.dev_type in ['ЭРЧМ30Т4-02-01', 'ЭРЧМ30Т4-02-02', ]:
...
class DISelectFirst(QtCore.QState):
    ...
    def onEntry(self, QEvent):
        ...
        t3 = ['ЭРЧМ30Т3-06', 'ЭРЧМ30Т3-04', 'ЭРЧМ30Т3-07', 'ЭРЧМ30Т3-12', 'ЭРЧМ30Т3-12-01', 'ЭРЧМ30Т3-12-02',
              ...
              'ЭРЧМ30Т3-10-01']
        t4 = ['ЭРЧМ30Т4-01', 'ЭРЧМ30Т4-02', 'ЭРЧМ30Т4-02-01', 'ЭРЧМ30Т4-02-02', 'ЭРЧМ30Т4-03']
...
class DIShowTable(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText(f'<p>Для каждого столбца таблицы необходимо проверить совпадают ли '
                         ...
                         f'Нажмите кнопку "ДА" для продолжения<br>'
...
class DIResult(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        if pas:
            ...
            res += pas
            res += '</p>'
        res += '<p>Нажмите "ДА" для продолжения</p>'
...
class FICheck(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        if bu.dev_type in ['ЭРЧМ30Т3-12', 'ЭРЧМ30Т3-12-01', 'ЭРЧМ30Т3-12-02', 'ЭРЧМ30Т3-12-03', 'ЭРЧМ30Т4-02',
                           'ЭРЧМ30Т4-02-01', 'ЭРЧМ30Т4-02-02', 'ЭРЧМ30Т4-03']:
            f = '0194'
        elif bu.dev_type in ['ЭРЧМ30Т4-01']:
            f = '0060'
        else:
        ...
        com.text.setText(f'<p>Установите на программаторе режим <b><font color="blue">"РЕА0"</font></b>. '
                         f'Для этого зажмите кнопку 1 для выбора '
                         f'режима или кнопку 2 для выбора подрежима и кнопками 5 и 6 установите значение А0. На '
                         f'нижнем ряде индикаторов программатора должно быть: '
                         f'<b><font color="green">{f}</font></b></p><p></p>'
                         f'Если это условие выполняется нажмите <font color="green">"ДА"</font>,'
                         f'<br>Если условие не выполняется нажмите <font color="red">"НЕТ"</font>.</p>'
                         )
...
class FiParamSave(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        if bu.dev_type in ['ЭРЧМ30Т3-12', 'ЭРЧМ30Т3-12-01', 'ЭРЧМ30Т3-12-02', 'ЭРЧМ30Т3-12-03', 'ЭРЧМ30Т4-02',
            ...
            f = '0124'
        com.text.setText(f'<p>Кнопками 5 и 6 установите на нижнем ряде индикаторов значение '
                         f'<b><font color="green">{f}</font></b>.</p><p>После чего удерживая кнопку 1 или кнопку 2 '
                         f'кнопками 5 и 6 установите  режим <b><font color="blue">"PEF0"</font></b>. '
                         f'Затем нажмите и удерживайте кнопку 3 и '
                         f'кратковременно нажмите кнопку 6. Через несколько секунд, после изменения показаний '
                         f'индикаторов программатора, отпустите кнопку 3.</p><p><br>Нажмите '
                         f'"ДА" для продолжения</p>'
                         )
...
class FiConfig(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        if bu.dev_type in ['ЭРЧМ30Т3-12', 'ЭРЧМ30Т3-12-01', 'ЭРЧМ30Т3-12-02', 'ЭРЧМ30Т3-12-03']:
            com.args = (
                ('РЕ10', 'верхнего', '0495-0502', 'ЧВХ1 - ДЧД', [1616, 0, 0]),
                ('РЕ70', 'верхнего', '01.00-06.00', 'ЧВХ3 - ДП 25 кГц', [0, 0, 25000]),
                ('РЕ70', 'верхнего', '14.00-25.00', 'ЧВХ3 - ДП 17 кГц', [0, 0, 17000]))
        elif bu.dev_type in ['ЭРЧМ30Т4-01']:
            com.args = (
                ('РЕ10', 'верхнего', '0495-0505', 'ЧВХ1 - ДЧД', [500, 0, 0]),
            )
        elif bu.dev_type in ['ЭРЧМ30Т4-02', 'ЭРЧМ30Т4-02-01']:
            com.args = (
                ('РЕ10', 'верхнего', '0543-0547', 'ЧВХ1 - ДЧД 545 Гц', [1746, 0, 0]),
                ('РЕ10', 'верхнего', '1392-1398', 'ЧВХ1 - ДЧД 1395 Гц', [4462, 0, 0]),
            )
        elif bu.dev_type in ['ЭРЧМ30Т4-02-02']:
            com.args = (
                ('РЕ10', 'верхнего', '0537-0545', 'ЧВХ1 - ДЧД 545 Гц', [1746, 0, 0]),
                ('РЕ10', 'верхнего', '1377-1383', 'ЧВХ1 - ДЧД 1395 Гц', [4462, 0, 0]),
            )
        elif bu.dev_type in ['ЭРЧМ30Т4-03', ]:
            com.args = (
                ('РЕ10', 'верхнего', '0537-0543', 'ЧВХ1 - ДЧД 545 Гц', [1746, 0, 0]),
                ('РЕ10', 'верхнего', '1377-1383', 'ЧВХ1 - ДЧД 1395 Гц', [4462, 0, 0]),
            )
        else:
            com.args = (
...
class FiSetF(QtCore.QState):
    ...
    def onEntry(self, QEvent):
        global com, attempts, MAX_ATTEMPTS
        attempts+=1
        ...
        com.text.setText(com.text.text() + f'<p>Текущая частота {f[0]}, {f[1]}, {f[2]}</p>')
        if all(f) or attempts>MAX_ATTEMPTS:
            attempts=0
            self.done.emit()
    ...
    def onEntry(self, QEvent):
        ...
        if com.idx < len(com.args):
            ...
            com.text.setText('<p>Зажав кнопку программатора 1 или 2 установите при помощи кнопок 5 и 6 '
                             ...
                             '<p>Если это условие выполняется нажмите <font color="green">"ДА"</font>,'
                             '<br>Если условие не выполняется нажмите <font color="red">"НЕТ"</font>.</p>'
                             ''.format(*args))
        else:
            self.done.emit()
...
class ShimCheck(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Установите на программаторе режим <b><font color="blue">"PE80"</font></b>. '
                         ...
                         '</p><p><br>Нажмите "ДА" для продолжения</p>'
                         )
...
class ShimSaveI1(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Установите при помощи кнопки 6 значение '
                         ...
                         '<p><br>Нажмите "ДА" для продолжения</p>')
...
class ShimRegOff(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Установите на программаторе режим <b><font color="blue">"PE10"</font></b>. '
                         'Для этого зажав кнопку 1 или 2 кнопками'
                         ' 5 и 6 установите требуемое значение режима.</p>'
                         '</p><p><br>Нажмите "ДА" для выхода в меню</p>'
                         )
...
class AiCheck(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        if bu.dev_type in ['ЭРЧМ30Т4-02-02']:
            com.idx = 2
...
class AIMeasure(QtCore.QState):
    ...
    def onEntry(self, QEvent):
        ...
        com.text.setText(f'<p>Для проверки канала {ch} установите на программаторе режим '
                         ...
                         '<p><br>Нажмите <font color="green">"ДА"</font> для продолжения,<br>'
                         f'Если значение {val} установить не удалось нажмите <font color="red">"НЕТ"</font>.</p>'
                         )
    ...
    def onEntry(self, QEvent):
        if com.idx == 2:
            com.text.setText('<p>Установите на программаторе режим '
                             ...
                             'удерживая кнопку 1 или 2 программатора кнопками 5 и 6 установите требуемое '
                             'значение режима.</p>'
                             '<p><br>Нажмите <font color="green">"ДА"</font> для продолжения.</p>'
                             )
        else:
            self.done.emit()
...
class AIRes(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        check = [norm[i] - 0.05 <= val[i] <= norm[i] + 0.05 for i in range(len(val))]
        ...
        if bu.dev_type in ['ЭРЧМ30Т4-02-02']:
            com.text.setText(f'<p>Резудьтаты испытания аналоговых входов АВХ1 - ДДН и АВХ2 - ДДМ</p>'
                             ...
                             f'{row[1]}'
                             f'{table_bottom}</p>'
                             f'<p><br>Нажмите "ДА" для продолжения.</p>')
        else:
            com.text.setText(f'<p>Резудьтаты испытания аналоговых входов АВХ1 - ДДН и АВХ2 - ДДМ</p>'
                             f'<p>{table_header}'
                             f'{row[0]}'
...
class RtCheck(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText(f'<p>Для проверки канала АВХ3 - датчика температуры установите на программаторе режим '
                         ...
                         '<p><br>Нажмите <font color="green">"ДА"</font> для продолжения,<br>'
                         f'Если значение отличается нажмите <font color="red">"НЕТ"</font>.</p>'
                         )
    ...
    def onEntry(self, QEvent):
        ...
        if bu.rt_1 + bu.rt_2 + bu.rt_3 == 3:
            com.text.setText('<p>Проверка завершена <b><font color="green">успешно</font></b>.'
                             '<p><br>Нажмите "ДА" для продолжения.'
                             )
...
class FICheckR(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText('<p>Установите на программаторе режим <b><font color="blue">"РЕ70"</font></b>.</p>'
                         ...
                         'Если это условие выполняется нажмите <font color="green">"ДА"</font>,'
                         '<br>Если условие не выполняется нажмите <font color="red">"НЕТ"</font>.</p>'
                         )
